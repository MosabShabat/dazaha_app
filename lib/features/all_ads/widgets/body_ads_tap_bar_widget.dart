...
class BodyAdsTapBarWidget extends StatefulWidget {
  final AllAdsController controller;

  const BodyAdsTapBarWidget({super.key, required this.controller});

  @override
  State<BodyAdsTapBarWidget> createState() => _BodyAdsTapBarWidgetState();
}

class _BodyAdsTapBarWidgetState extends State<BodyAdsTapBarWidget> {
