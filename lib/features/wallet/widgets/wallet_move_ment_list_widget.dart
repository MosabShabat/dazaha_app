...
Widget WalletMoveMentListWidget(
  ...
  return SingleChildScrollView(
    child: ListView.builder(
      ...
      itemCount: controller.recordTransactionsModel.length,
      shrinkWrap: true,
      physics: NeverScrollableScrollPhysics(),

      itemBuilder: (context, index) {
        if (index < controller.recordTransactionsModel.length) {
        } else if (controller.isLoadingMore.value) {}

        if (controller.recordTransactionsModel.isEmpty) {
          return Column(
        ...
        var transactions = controller.recordTransactionsModel[index];
        return ListTile(
