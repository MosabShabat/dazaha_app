...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 22
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.22"
