...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 32
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.32"
