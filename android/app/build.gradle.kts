...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 41
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.41"
