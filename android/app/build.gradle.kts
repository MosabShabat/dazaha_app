...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 30
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.30"
