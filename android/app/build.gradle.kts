...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 24
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.24"
