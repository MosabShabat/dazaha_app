...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 16
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.0.16"
